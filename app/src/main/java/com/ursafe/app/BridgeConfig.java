...
public final class BridgeConfig {
    public static final String REPOSITORY = "bulaxrusi-design/Coding";
    public static final String BRANCH = "ursafe-device-bridge";
    public static final String RAW_BASE =
