...
public final class BridgeActionReceiver extends BroadcastReceiver {
    ...
    @Override public void onReceive(Context context, Intent intent) {
        ...
        if (job == null) {
            BridgeNotifications.showMessage(context, "Ursafe bridge", "დავალება აღარ არის აქტიური ან უკვე დამუშავებულია.", 6301);
            return;
        }
        ...
        try {
            ...
            BridgeNotifications.showMessage(context, "Ursafe bridge შეცდომა", message,
                    jobId.hashCode());
        }
    }

    public static void publishJsonResult(Context context, String jobId, JSONObject result) {
        try {
            ...
            BridgeNotifications.showMessage(context, "შედეგი ლოკალურად დარჩა",
                    "დაშიფრული შედეგის ატვირთვა ვერ მოხერხდა: " + safe(error.getMessage()), 6302);
        }
    }

    public static void publishTerminalResult(Context context, String jobId, String status,
